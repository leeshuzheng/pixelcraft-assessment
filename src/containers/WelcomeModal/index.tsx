...
const WelcomeModal: React.FC<WelcomeModalProps> = () => {
  return (
    <div className="fixed inset-0 z-10 overflow-y-auto">
      <div className="flex flex-col min-h-full mx-auto items-end justify-center sm:items-center px-6 lg:px-4 w-full z-10 font-pixelar">
        <div className="w-full max-w-[810px]">
          ...
          <div className="flex flex-col items-center gap-5 md:gap-7 mb-11 bg-gradient-yellow w-full relative">
            ...
            <div className="flex flex-row align-center gap-4 px-8 md:gap-5">
              <Image src={GotchiEth} alt="Gotchi ETH" />
              <aside className="flex flex-col">
                <h2 className="text-3xl md:text-[42px] md:leading-10 uppercase">
                  There are <span className="text-yellow">17</span> Gotchis
                  ahead of you
                </h2>
                <span className="text-2xl md:text-[30px] uppercase">
                  You will automatically join once a spot opens!
                </span>
              </aside>
            </div>
          </div>
          <div className="flex flex-col items-center gap-4 md:gap-[30px] relative w-full pb-[10px]">
            <div className={styles.trapezoid2}></div>
            <div className={styles.leftBorderBottom}></div>
            <div className={styles.rightBorderBottom}></div>
            ...
            <span className="text-cyan2 uppercase text-2xl md:text-[32px]">
            ...
            <h5 className="uppercase text-yellow text-xl leading-tight md:text-[28px] md:leading-[26px] max-w-[55%] text-center md:mt-5">
